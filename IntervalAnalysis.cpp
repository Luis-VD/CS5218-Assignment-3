...
int main(int argc, char **argv)
{
    ...
    // 2.Define analysisMap as a mapping of basic block labels to empty set:
    ...
    //Perform a basic check of the blocks ranges using an empty map as a reference starting point
    ...
    //Final step, printing of the final analysis map with all of the elements found
